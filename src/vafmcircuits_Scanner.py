...
class scanner(Circuit):
	...
	def Place (self,x,y,z):
		...
		self.y = y
		self.z = z
		print "Cantilever places at position " +str(x) +str(y) +str(z)
	...
	def Move (self,x,y,z,v):
		...
		for i in range( time  ):
			...
			self.machine.Update()
		print "Cantilever moved to position " +str( self.deltax ) + " " +str(self.deltax)+ " " +str(self.deltax) +" in " +str(time*self.machine.dt) + " seconds"		
